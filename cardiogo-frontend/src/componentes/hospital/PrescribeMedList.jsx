...
const PrescribeMedList = () => {
  ...
  useEffect(() => {
    setIsLoading(true);
    api
      .getRecetasByPacienteId(`${pacienteId}`)
      .then((res) => {
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-dark font-semibold">
                            {formatUTCDate(item.receta.fecha_vencimiento)}
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pt-3 border-t border-gray-light">
                      <div className="flex items-start gap-2">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary to-primary-dark flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
                          {item.medico?.nombre_completo?.charAt(0) || "M"}
                        </div>
                        <div className="flex-1">
                          <p className="text-xs text-gray-medium mb-0.5">
                            Médico Responsable
                          </p>
                          ...
                          <p className="text-xs text-gray-medium mt-0.5">
                            ...
                            <span className="font-semibold">
                              {item.medico?.cedula_profesional ||
                                "No registrada"}
                            </span>
                          </p>
                        </div>
...
export default PrescribeMedList;