...
import { X, Pill, Droplet, Syringe, TestTube, Package, Hash, Check, CheckCircle } from "lucide-react";
...
const AddMedicineModal = ({
  ...
  return (
    <div className="p-6 sm:p-8">
      ...
      {/* ERROR MESSAGE */}
      {error && (
        <div className="mb-6 p-4 bg-danger-light border-l-4 border-danger rounded-xl flex items-start gap-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                ...
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <div className="relative group">
                    ...
                    />
                    <Pill className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium group-focus-within:text-primary transition-colors" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className="w-full px-4 py-3 pl-11 bg-gray-light border-2 border-gray-light rounded-xl outline-none focus:border-primary focus:bg-white transition-all text-primary-dark placeholder:text-gray-medium hover:border-primary/30"
                    />
                    <Droplet className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium group-focus-within:text-primary transition-colors" />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className="w-full px-4 py-3 pl-11 bg-gray-light border-2 border-gray-light rounded-xl outline-none focus:border-primary focus:bg-white transition-all text-primary-dark placeholder:text-gray-medium hover:border-primary/30"
                    />
                    <TestTube className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium group-focus-within:text-primary transition-colors" />
                  </div>
                </div>
              </div>
            </div>

            {/* Sección: Presentación y Administración */}
            <div>
              <div className="flex items-center gap-2 mb-4 pb-2 border-b border-gray-light">
                <h3 className="text-base sm:text-lg font-bold text-gray-dark">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Syringe className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium pointer-events-none group-focus-within:text-primary transition-colors" />
                    <svg
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Package className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium pointer-events-none group-focus-within:text-primary transition-colors" />
                    <svg
                      className="absolute right-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium pointer-events-none"
                      fill="none"
                      stroke="currentColor"
                ...
                <div className="space-y-2 sm:col-span-2">
                  ...
                  <div className="relative group">
                    <input
                      ...
                      className="w-full px-4 py-3 pl-11 bg-gray-light border-2 border-gray-light rounded-xl outline-none focus:border-primary focus:bg-white transition-all text-primary-dark placeholder:text-gray-medium hover:border-primary/30"
                    />
                    <Hash className="absolute left-3.5 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-medium group-focus-within:text-primary transition-colors" />
                  </div>
                </div>
              </div>
            </div>
