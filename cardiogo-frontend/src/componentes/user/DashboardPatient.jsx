...
const DashboardPatient = () => {
  ...
  const fetchVitalSigns = () => {
    ...
    api
      .getVitalSignsByPacienteId(pacienteId)
      .then((response) => {
  ...
  useEffect(() => {
    setIsLoading(true);
    api
      .getNormalSignsPacienteJ(pacienteId)
      .then((response) => {
        const data = response?.data?.data || [];
        setNormalSigns(data);
      })
        ...
        >
          <div className="flex items-center gap-4 mb-2">
            ...
            <div>
              ...
              <p className="text-slate-600 flex items-baseline gap-2">
              ...
              <div className="p-4 space-y-2">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-3 text-center border border-primary/20">
                    ...
                    <p className="text-2xl font-bold text-slate-900 flex items-baseline justify-center gap-2">
                      {modalData.data.valor}
